...
public interface QueueService {
    ...
    RequestDTORequest addRequest(ClientDTORequest clientDTORequest, RequestType requestType, String appointmentTime); //добавляю заявку в очередь на обслуживание и возвращаю добавленную заявку
    RequestDTORequest getCurrentRequest(); //возвращаю текущую заявку из очереди на обслуживание
